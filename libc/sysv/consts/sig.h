...
#define SIGBUS    ACTUALLY(SIGBUS)
#define SIGTHR    ACTUALLY(SIGTHR)
#define SIGCHLD   ACTUALLY(SIGCHLD)
#define SIGCONT   ACTUALLY(SIGCONT)
#define SIGEMT    ACTUALLY(SIGEMT)
#define SIGINFO   ACTUALLY(SIGINFO)
#define SIGIO     ACTUALLY(SIGIO)
#define SIGPOLL   ACTUALLY(SIGPOLL)
#define SIGPWR    ACTUALLY(SIGPWR)
#define SIGRTMAX  ACTUALLY(SIGRTMAX)
#define SIGRTMIN  ACTUALLY(SIGRTMIN)
#define SIGSTKFLT ACTUALLY(SIGSTKFLT)
#define SIGSTOP   ACTUALLY(SIGSTOP)
#define SIGSYS    ACTUALLY(SIGSYS)
#define SIGTSTP   ACTUALLY(SIGTSTP)
#define SIGUNUSED ACTUALLY(SIGUNUSED)
#define SIGURG    ACTUALLY(SIGURG)
#define SIGUSR1   ACTUALLY(SIGUSR1)
#define SIGUSR2   ACTUALLY(SIGUSR2)

#define SIG_BLOCK   ACTUALLY(SIG_BLOCK)
#define SIG_SETMASK ACTUALLY(SIG_SETMASK)
#define SIG_UNBLOCK ACTUALLY(SIG_UNBLOCK)
